...
import { loadEpic as loadInvoices, updateEpic as updateInvoice, updateSuccessEpic as succesfullyUpdateInvoice } from './Ducks/Invoices'
...
const epicMiddleware = [
  ...
  createEpicMiddleware(succesfullyUpdateInvoice),
